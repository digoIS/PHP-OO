...
class Pagina extends TPage
{
	...
	function onProdutos($get)
	{
		...
		//adiciona o texto na linha do conteúdo da tabela
	...
	/**
	 * método onContato()
	 * executado qunado o usuário clicar no link "Contato"
	 * @param $get = varável $_GET
	 */
	function onContato()
	{
	...
	function onEmpresa($get)
	{
		...
		//aiciona otexto na linha do conteúdo da tabela
		$celula = $this->content->addCell($texto);
		$celula->colspan = 3;
	}	
}
...
//exibe página juntamente com seu contúdo e interpreta a URL
$pagina->show();
