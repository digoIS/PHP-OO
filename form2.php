...
/**
 * função __autoload()
 * carregha uma classe quando ela é necessária
...
class EmailForm extends TPage
{
	...
	function __construct()
	{
		...
		//adiciina uma linha para o campo email
		$row=$table->addRow();
		...
		//define quais saõ os campos do formulário
	...
	/**
	 * função onSend
	 * exibe a mensagem "Enviando dados"
	 */
	function onSend()
	{
		// obtém os dados do formulário
		$data = $this->form->getData();
		//atribui os dados de volta ao formulárioo
		$this->form->setData($data);
		//torna o formulário não-editavel
