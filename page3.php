...
/**
 * método onContato()
 * executado quando o o usuário clicar no link "Contato"
 * @param $get = variável $_GET 
 */
function onContato($get)
{
	echo "Para entrar em contato com anossa empresa,
...
function onEmpresa()
{
	echo  "Aqui na fazenda recanto escondido fazemos eco-tursmo,
			você vai poder conhecer nossas instalações,
			tirar leite diretamente da vaca, rcolher os ovos do galinheiro e o mais
