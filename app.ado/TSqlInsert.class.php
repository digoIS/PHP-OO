...
/*
 * classe TsqlInsert
 * Esta calsee provê meios para manipulação de uma instrução Insert no banco de dados
 */
final class TSqlInsert extends TSqlInstruction
{
	...
	/*,
	 * metodo get instruction()
	 * retorna a instrução sql de INSERT em forma de string.
	 */
