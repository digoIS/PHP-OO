 ...
 * ou seja , quando ela é instancia pe,la primeira vez 
 */
...
//ajustando o tamanhio destes campos
$codigo->setSize(70);
$nome->setSize(140);
...
//adiciona inha na tabela para o endereço
$row=$table2->addRow();
$row->addCell($label4);
$row->addCell($endereco);

//adiciona linha na tebla para o telefone
$row=$table2->addRow();
$row->addCell($label5);
