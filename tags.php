...
$br = new TElement('br');
$center->add($br); // adicionao ao body
...
$center->add($input); // adiociona ao body

//exibe o html com todos seus elemntos filhos
