...
class TStyle
{
	...
	/**
	 * método __set()
	 * intercepta as atribuições 'a propriedades do objeto
	 * @param $name = nome da proriedade
	 * @param $value = valor
	 */
	public function __set($name, $value)
	{
		// substitui op "_" por "-" no nome da propriedade
	...
	{
		// veriica se este estilo já foi carregado
