...
class TWindow
{
	...
	{
		//incrmeenta o contador de janelas
	...
	/**
	 * método setPosition()
	 * define a coluna e linha (x,y) que a janela será exibida na tela
	...
	public function show()
	{
		...
		//de posisionamento e dimensão da camada criada
		...
		//cria a tag <div> para a camada que representará a janela
		$painel = new TElement('div');
		$painel->id	= $window_id; 		//define o ID
		$painel->class = $window_id;	// define a classe CSS

		//insatncia objeto TTable
		$table = new TTable;
		...
		//adiciona uma célukla para título
