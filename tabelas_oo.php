...
$dados[] = array(3, 'João d Barro', 	'http://www.joao.com.br', 	1500);
$dados[] = array(4, 'Joana Pereira', 	'http://www.joana.com.br', 	700);
$dados[] = array(5, 'Erasmos Carlos', 	'http://www.erasmo.com.br', 2500);
...
{
	//verifica qual cor utiliza para o fundo
...
//instancia uma nova linnha para o totalizador
$linha = $tabela->addRow();
